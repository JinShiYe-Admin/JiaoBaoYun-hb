...
var storageKeyName = (function(mod) {
	...
	mod.MAINQIUZHI = 'http://192.168.0.106:8081/JiaoBaoCloudService/'; //作业主url
		//---开发---end---
...
//	mod.QNGETTOKENDELETE = 'http://114.215.222.186:8003/BatchDelete.ashx'; //获取批量（或者一个）删除七牛文件的token的url
	...
	mod.DEFAULTPERSONALHEADIMAGE = mod.QNDEFAULTIMAGEDOMAIN + 'default_personalimage.png'; //默认的个人头像
