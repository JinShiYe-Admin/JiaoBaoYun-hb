...
function postData_jiaobaoYunPro_getNoReadNotesCntByUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'note/getNoReadNotesCntByUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getNoReadNotesByUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'note/getNoReadNotesByUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getNoReadNotesCntByUserForStudent(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'note/getNoReadNotesCntByUserForStudent', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getNoReadNotesByUserForStudent(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'note/getNoReadNotesByUserForStudent', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getNotesCntByStudent(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'note/getNotesCntByStudent', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getNotesByStudent(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'note/getNotesByStudent', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getNoteById(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'note/getNoteById', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_addNote(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'note/addNote', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_addNoteForUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'note/addNoteForUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_setNoteReadByUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'note/setNoteReadByUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_setOffNoteById(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'note/setOffNoteById', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_delNoteById(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'note/delNoteById', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getNoReadClassSpacesCntByUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'classSpace/getNoReadClassSpacesCntByUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getNoReadClassSpacesByUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'classSpace/getNoReadClassSpacesByUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getNoReadClassSpacesCntByUserForClass (commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'classSpace/getNoReadClassSpacesCntByUserForClass', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getNoReadClassSpacesByUserForClass(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'classSpace/getNoReadClassSpacesByUserForClass', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getClassSpacesCntByClass(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'classSpace/getClassSpacesCntByClass', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getClassSpacesByClass(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'classSpace/getClassSpacesByClass', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getClassSpaceById(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'classSpace/getClassSpaceById', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_addClassSpace(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'classSpace/addClassSpace', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_addClassSpaceForUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'classSpace/addClassSpaceForUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_setClassSpaceReadByUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'classSpace/setClassSpaceReadByUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_setOffClassSpaceById(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'classSpace/setOffClassSpaceById', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_delClassSpaceById(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'classSpace/delClassSpaceById', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getNoReadUserSpacesCntByUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/getNoReadUserSpacesCntByUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getNoReadUserSpacesByUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/getNoReadUserSpacesByUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getNoReadUserSpacesCntByUserForPublisher(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/getNoReadUserSpacesCntByUserForPublisher', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getNoReadUserSpacesByUserForPublisher(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/getNoReadUserSpacesByUserForPublisher', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getIsLikeUserSpaceByUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/getIsLikeUserSpaceByUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getUserSpaceCommentsCntById(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/getUserSpaceCommentsCntById', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getUserSpaceCommentsById(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/getUserSpaceCommentsById', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getIsLikeUsersById(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/getIsLikeUsersById', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getUserSpaceCommentReplysCntByUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/getUserSpaceCommentReplysCntByUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getUserSpaceCommentReplysByUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/getUserSpaceCommentReplysByUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getUserSpacesCntByUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/getUserSpacesCntByUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getUserSpacesByUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/getUserSpacesByUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getUserSpaceByIdr(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/getUserSpaceById', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_addUserSpace(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/addUserSpace', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_addUserSpaceForUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/addUserSpaceForUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_addUserSpaceComment(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/addUserSpaceComment', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_addUserSpaceCommentReply(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/addUserSpaceCommentReply', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_setUserSpaceReadByUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/setUserSpaceReadByUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_setUserSpaceLikeByUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/setUserSpaceLikeByUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_setUserSpaceCommentReplyById(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/setUserSpaceCommentReplyById', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_setOffUserSpaceById(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/setOffUserSpaceById', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_delUserSpaceById(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/delUserSpaceById', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_delUserSpaceCommentById(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/delUserSpaceCommentById', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getUserSpaceMsgsCntById(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/getUserSpaceMsgsCntById', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getUserSpaceMsgsById(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/getUserSpaceMsgsById', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getUserSpaceMsgReplysCntByUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/getUserSpaceMsgReplysCntByUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getUserSpaceMsgReplysByUser(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/getUserSpaceMsgReplysByUser', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_addUserSpaceMsg(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/addUserSpaceMsg', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_addUserSpaceMsgReply(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/addUserSpaceMsgReply', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_setUserSpaceMsgReplyById(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/setUserSpaceMsgReplyById', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_delUserSpaceMsgById(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/delUserSpaceMsgById', enData, commonData, 1, wd, callback);
}
...
function postData_jiaobaoYunPro_getAboutMe(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'userSpace/getAboutMe', enData, commonData, 1, wd, callback);
}